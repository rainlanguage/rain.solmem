...
library LibMemCpy {
    ...
    /// writes are completely unsafe, the caller MUST ensure that sufficient
    /// memory is allocated and reading/writing the requested number of bytes
    /// from/to the requested locations WILL NOT corrupt memory in the
